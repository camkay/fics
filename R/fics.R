...
fics <- function(topic) {
  ...
  # load items
  items <- c("The real truth about _topic_ is being kept from the public.",
             "There is something very suspicious about the things the public has been told about _topic_.",
             "People need to wake up and start asking questions about _topic_.",
             "Those in power are going to a great deal of trouble to keep _topic_ from being thoroughly investigated.",
             "If most people knew the real truth about _topic_, there would be riots in the streets.",
             "It’s very suspicious that so few people in the media question whether we’re being told the truth about _topic_.",
             "When it comes to _topic_, most people are asleep and need to wake up.",
             "Those in power are very nervous that the public will realize the truth about _topic_.",
             "We may never know the full truth about _topic_, but it's clear that the mainstream story is a complete lie.",
             "The facts about _topic_ simply don’t match what we’ve been told by 'experts' and the mainstream media.",
             "We need a new, unbiased investigation to uncover the real truth about _topic_.",
             "Anyone who's been paying attention knows that we're being lied to about _topic_, but most people are simply brainwashed.",
             "Reporters, scientists, and government officials are involved in a conspiracy to cover up important information about _topic_.",
             "We may never know the full truth about _topic_, but it's clear that the mainstream story is a complete lie.",
             "If the truth about _topic_ came out, it would hurt the interests of some extremely powerful people.",
             "The mainstream media could never have an honest discussion about _topic_ - there are too many powerful interests at work.",
             "An impartial, independent investigation of _topic_ would show once and for all that we've been lied to on a massive scale.")
