#' fics
#'
#' A function for creating items assessing the belief in a conspiracy about a given topic. The items are created using the Flexible Inventory Conspiracy Suspicions (FICS) template (Wood, 2017).
